...
def main(args):
    ...
    if not args.test and (local_rank==0 or local_rank is None):
        clean_pretrained_class = args.pretrained_class.replace("/","_")
        save_path = f"trained_models/ft_{args.model}_{clean_pretrained_class}_{args.core_lr}_{args.head_lr}.pth" 
